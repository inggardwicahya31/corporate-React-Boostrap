...
export default function AppTestimonials() {
  return (
    <section 
      ...
      // Tambahkan style di bawah ini untuk Background
      style={{ 
        backgroundImage: `url(${require('../assets/images/bg-testimonial.jpg')})`,
    ...
    >
      <Container fluid>
        <div className='title-holder'>
          <h2 className="text-white">Client testimonials</h2>
          <div className='subtitle text-white'>what client says about us</div>
        </div>
